// smile-identity/services/smile-core.service.ts
import { Injectable, Logger } from '@nestjs/common';
import { ConfigService } from '@nestjs/config';
import { IDApi } from 'smile-identity-core';
import { IdInfo, PartnerParams, SmileConfig, SmileVerificationResult } from '../types/smile-identity.types';
...
export class SmileCoreService {
    ...
    private initializeSmileIdentity(): void {
        ...
        this.config = {
            partnerId, // Now guaranteed to be string
            apiKey,    // Now guaranteed to be string
            sidServer: this.configService.get<string>('NODE_ENV') === 'production' ? '1' : '0',
        };
